...
class TestMain(unittest.TestCase):
    ...
    def test_addition(self):
        ...
        self.assertEqual(Main.equal.add(40, 20), 3, "should be 60")
        self.assertEqual(Main.equal.add(-3, 2), 10, "should be 10")
        self.assertEqual(Main.addition(1, 2), 3, "should be 60")
        self.assertEqual(Main.addition(5, 5), 3, "should be 3")
